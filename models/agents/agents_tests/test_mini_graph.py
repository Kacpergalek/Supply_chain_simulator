...
G.add_edge(1, 2, key=0, length=150000, cost=50.0, maxspeed = "100")    # 250 km
G.add_edge(1, 3, key=0, length=120000, cost=50.0, maxspeed = 150)     # 120 km
G.add_edge(3, 2, key=0, length=10000, cost=20.0, maxspeed=150)     # 130 km
...
params = {"alpha":1.0, "beta":1.0, "avg_speed_km_per_day": 60.0}
